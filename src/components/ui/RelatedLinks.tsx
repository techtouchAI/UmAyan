...
export function RelatedLinks({ links }: RelatedLinksProps) {
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-700/50 rounded-2xl p-6 sm:p-8 mb-10">
      <h3 className="text-lg sm:text-xl font-bold mb-4 flex items-center gap-2 text-slate-900 dark:text-white">
      ...
      <ul className="space-y-3 list-disc list-outside ms-4 marker:text-slate-900 dark:marker:text-white">
